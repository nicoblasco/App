	...
	<el-dialog :show-close="true" :custom-class="'user-dialog'" :visible="dialogvisible" @close="$emit('update:dialogvisible', false)">
		...
		<div class="form-box">
			<el-form label-width="100px" size="small" :model="data" ref="data">	<!-- Agregado -->
				<el-form-item label="Proveedor" prop="razonSocial"
         :rules="[{ required: true, message:  'Por favor ingrese el nombre del proveedor', trigger: 'blur'   },{ min: 1, max: 50, message: 'Debe tener entre 1 y 50 caracteres' }]">					
					<el-input v-model="data.razonSocial"></el-input>
				</el-form-item>
				...
				<el-form-item label="Website">
					<el-input placeholder="pagina web" v-model="data.website">
...
export default {
	name: 'UserDialog',
	props: ['data', 'dialogvisible','cities','documentType'],
	data() {
		return {
